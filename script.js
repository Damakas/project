...
let sumArea = shops.reduce((accumlator,item) => {
    return accumlator + (item.width * item.length); 
},0);
let mallVolume = sumArea * data.height;

if(data.budget - (mallVolume * data.moneyPer1m3) >= 0 ){
